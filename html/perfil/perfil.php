																						...
																						<div class="portlet light profile-sidebar-portlet ">
																								...
																								<div class="profile-usermenu">
																										<ul class="nav">
																											...
																											<li class='active'>
																												<a href="?view=perfil&mode=edit&id=<?php echo $_GET['id'];?>">
																														<i class='icon-settings'></i>Editar informacion Personal</a>
																											</li>
																											<li class='active'>
																												<a href="?view=logout">
																												...
																												<div class="portlet-body">
																														<div class="tab-content">
																																...
																																<div class="tab-pane active" id="tab_1_1">
																																		<form action="?view=perfil&mode=edit&id=<?php echo $_GET['id'];?>" method="POST" id="form_perfil" name="form_perfil" enctype="application/x-www-form-urlencoded" novalidate="novalidate">
																																				<div class="form-body">
																																						...
																																						<div class="form-group form-md-line-input form-md-floating-label">
																																								<input class="form-control" name="informacion" id="informacion" rows="3" <input value="<?php echo $_users2[$_GET['id']]['informacion']; ?>">
																																...
																																<div class="tab-pane" id="tab_1_3">
																																		<form action="#" id="form_contrasena" novalidate="novalidate">
																																				<div class="form-group form-md-line-input form-md-floating-label">
