                  ...
                  <tr>
                    <td class="bg bg1" style="background-color:#fff;">
                      ...
                      <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                          <td>
                            <img src="https://s3.postimg.org/w87zm9yhv/screen_settings.png" style="max-width:100%; display:block;">
                          </td>
                        </tr>
                      </table>
                    </td>
                          ...
                          <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                            <tr>
                              <td style="text-align:left; color: #6f6f6f;">
                                ...
                                <p319db5>
                                Hola '.$user.',<br><br>
                              Te enviamos este correo con la finalidad puedas regenerar tu contraseña. Si no has sido tú alguien lo hizó <a href="#" style="color:#646ea8">Contactanos</a>. <br><br>
                                Gracias por preferirnos como La mejor Pizzeria!<br>
                                Casa Italiana</p><br>
                            </tr>
                          </table>
                        </center>
