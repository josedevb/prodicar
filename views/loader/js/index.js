...
function shuffleArray(array) {
  for (var i = array.length - 1; i > 15; i--) {
...
document.addEventListener("DOMContentLoaded", function(event) {
  var phrases = (["", "", "Pedido Recibido", "Revisando Pedido", "Pedido Completado", "Preparando Pizza", "Colocandola en el Horno", "Sacandola del Horno", "Apagando el fuego", "Encendiendo Moto", "Guardando Pizza", "Pedido Completado", "Facturando", "Guardando Factura", "Enviando Pizza", "¡Compra Exitosa!"]);
